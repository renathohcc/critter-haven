"""Placeholders visuais das criaturas: formas simples, distinguíveis por
espécie e com indicador de raridade (GDD seção 8: comum neutro, rara
saturada, especial dourada)."""
...
def draw_creature(surface: pygame.Surface, creature: Creature) -> None:
